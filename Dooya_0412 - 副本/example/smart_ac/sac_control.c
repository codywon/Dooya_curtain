...
void custom_poll(void)
{
	...
	if (((rx_fsm == CRF_IDLE) || (rx_fsm == CRF_DATA_READY)) && (tick > inquire_interval))
	{
		inquire_interval = tick + INQUIRE_INTERVAL;
			//msg_queue_put(IDM_102_000_GET_STATUS_1, 0xf0, 0xf0);
			//msg_queue_put(IDM_102_000_GET_STATUS_1, 0xf0, 0xfc);
			//msg_queue_put(IDM_102_000_GET_STATUS_1, 0xf0, 0xfd);
			//msg_queue_put(IDM_102_000_GET_STATUS_1, 0xf0, 0xfe);
